    ...
    <div  classNmae = "container" id="portfolio">
        ...
        <div class="row">
         ...
         <div className='col-4' id="padding">
          <img id="card-img" alt="icon" src="https://github.com/MaryiaVinogradova/Portfolio/blob/main/src/images/6.png?raw=true" />
         </div>
         ...
         <div class="card-footer text-white text-center" id="color-cr-ft">
            <a style={cardStyle.cardIcon} className="link " href="https://connect-2-caller.herokuapp.com/" target="_blank "><i className="bi" id="icon">
            <GrHeroku></GrHeroku></i></a>
         </div>
        ...
        <div class="row">
         ...
         <div className='col-4' id="padding">
          <img id="card-img" alt="icon" src="https://github.com/MaryiaVinogradova/week5/blob/main/1.png?raw=true" />
         </div>
        ...
        <div class="row">
           ...
           <div className='col-8'>
            ...
            <div class="card-footer text-white text-center" id="color-cr-ft">
            <a style={cardStyle.cardIcon} className="link " href="https://note-tracker-app-mv.herokuapp.com/" target="_blank "><i className="bi" id="icon">
            <GrHeroku></GrHeroku></i></a>
            </div>
       ...
       <div class="row">
        ...
        <div className='col-4' id="padding">
         <img id="card-img" alt="icon" src="https://github.com/MaryiaVinogradova/Portfolio/blob/main/src/images/7.png?raw=true" />
        </div>
