    ...
    <div class="full-height">
      ...
      <div className='row' id="about-pd-10">
         <div className='col-3' id="about">
          ...
          <div className='col-2' id="icon-small">
            <img id="icon-side" alt="icon" src="https://github.com/MaryiaVinogradova/Portfolio/blob/main/src/images/icon1.jpg?raw=true"></img>
          </div>
      ...
      <div className='row pd-10' id="about about-pd-10">
         <div className='col-3' id="about">
          ...
          <div className='col-2' id="icon-small">
            <img id="icon-side" alt="icon" src="https://github.com/MaryiaVinogradova/Portfolio/blob/main/src/images/icon3.jpeg?raw=true"></img>
          </div>
      ...
      <div className='row pd-10' id="education about-pd-10">
         <div className='col-3' id="school">
          ...
          <div className='col-2' id="icon-small">
            <img id="icon-side" alt="icon" src="https://github.com/MaryiaVinogradova/Portfolio/blob/main/src/images/icon2.jpg?raw=true"></img>
          </div>
